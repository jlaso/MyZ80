 ...
 * 
 * add         UIManager.put("EditTextAreaUI", "jEditSyntax.EditTextAreaUI");
 * in your main
 */
public class JEditTextArea extends JTextArea //JTextComponent
{
    private static final String uiClassID = "EditTextAreaUI";
