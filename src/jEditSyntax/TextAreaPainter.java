...
public class TextAreaPainter extends JComponent implements TabExpander {
								   ...
								   Color defaultColor, int x, int y)
	{
		...
		String text = Integer.toString(currentLineIndex) + ": ";
		Segment lineNumber = new Segment(text.toCharArray(), 0, text.length());

        x += Utilities.drawTabbedText(lineNumber,x,y,gfx,this,0);
