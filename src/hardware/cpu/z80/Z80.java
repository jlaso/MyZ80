...
public class Z80 {
    ...
    protected boolean isSignPositive() {
        return (F & 0b10000000) == 0;
    }

    protected boolean isSignNegative() {
        return (F & 0b10000000) > 0;
    }
    ...
    protected boolean isNoCarry() {
        return (F & 0b00000001) == 0;
    }

    protected boolean isParityOdd() {
